...
_remainTxt = if (_remain > 0) then {str _remain + " items remain in your receptacle.\nYou can access it any time."} else {""};

_totalPrice = round _totalPrice;
["You received Q$ " + str _totalPrice + ". " + _remainTxt,(3.5 + _remain * 10) min 10,20,155] call BRPVP_hint;
